...
class sciencefragmnet : Fragment(){
    ...
    override fun onCreateView(
      ...
      val v:View = inflater.inflate(R.layout.sciencefragmnet,null)
        recyclerViewofscience = v.findViewById<View>(R.id.recyclerviewofscience) as RecyclerView?
