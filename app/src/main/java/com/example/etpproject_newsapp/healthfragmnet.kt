...
class healthfragmnet : Fragment(){
    ...
    override fun onCreateView(
      ...
      val v:View = inflater.inflate(R.layout.healthfragmnet,null)
        recyclerViewofhealth = v.findViewById<View>(R.id.recyclerviewofhealth) as RecyclerView?
